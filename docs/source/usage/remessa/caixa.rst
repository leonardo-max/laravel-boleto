...
.. code-block:: php
    ...
    // for 400 positions
    $send = new LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Caixa;

    // Or, for 240 positions
    $send = new LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Caixa;
...
.. code-block:: php
    ...
    // for 400 positions
    $send = new LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Caixa($sendArray);

    // Or, for 240 positions
    $send = new LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Caixa($sendArray);
