...
.. code-block:: php
    ...
    // for 400 positions
    $send = new LeonardoMax\LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Bb;

    // Or, for 240 positions
    $send = new LeonardoMax\LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Bb;
...
.. code-block:: php
    ...
    // for 400 positions
    $send = new LeonardoMax\LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Bb($sendArray);

    // Or, for 240 positions
    $send = new LeonardoMax\LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Bb($sendArray);
