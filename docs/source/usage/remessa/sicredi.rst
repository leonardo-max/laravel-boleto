...
.. code-block:: php
    ...
    // for 400 positions
    $send = new LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Sicredi;

    // Or, for 240 positions
    $send = new LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Sicredi;
...
.. code-block:: php
    ...
    // for 400 positions
    $send = new LaravelBoleto\Cnab\Remessa\Cnab400\Banco\Sicredi($sendArray);

    // Or, for 240 positions
    $send = new LaravelBoleto\Cnab\Remessa\Cnab240\Banco\Sicredi($sendArray);
